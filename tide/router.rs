...
impl<State: Clone + Send + Sync + 'static> Router {
...
async fn not_found_endpoint<State: Clone + Send + Sync + 'static>(_req: Request) -> crate::Result {
    Ok(Response::new(StatusCode::NotFound))
}

async fn method_not_allowed<State: Clone + Send + Sync + 'static>(_req: Request) -> crate::Result {
